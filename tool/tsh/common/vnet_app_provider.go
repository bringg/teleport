...
// necessary methods to list and log in to apps.
...
func newVnetAppProvider(cf *CLIConf) (*vnetAppProvider, error) {
	...
	p := &vnetAppProvider{
		...
		clusterConfigCache: vnet.NewClusterConfigCache(clockwork.NewRealClock()),
	}
...
func (p *vnetAppProvider) ResolveAppInfo(ctx context.Context, fqdn string) (*vnetv1.AppInfo, error) {
	return vnet.ResolveAppInfo(ctx, p, fqdn)
}
...
func (p *vnetAppProvider) GetCachedClusterConfig(ctx context.Context, clt vnet.ClusterClient) (*vnet.ClusterConfig, error) {
...
func (p *vnetAppProvider) ReissueAppCert(ctx context.Context, appInfo *vnetv1.AppInfo, targetPort uint16) (tls.Certificate, error) {
...
func (p *vnetAppProvider) GetDialOptions(ctx context.Context, profileName string) (*vnetv1.DialOptions, error) {
...
// anything extra here.
func (p *vnetAppProvider) OnNewConnection(_ context.Context, _ *vnetv1.AppKey) error {
	return nil
}
...
func (p *vnetAppProvider) OnInvalidLocalPort(ctx context.Context, appInfo *vnetv1.AppInfo, routeToApp *proto.RouteToApp) {
...
func (p *vnetAppProvider) getRootClusterCACertPoolPEM(ctx context.Context, profileName string) ([]byte, error) {
