...
description: Describes how to import and visualize Azure subscription access patterns using Teleport Policy and Access Graph.
---
...
- For self-hosted clusters:
  ...
  - A running Access Graph node v1.27.0 or later. Check the [Teleport Policy page](../teleport-policy.mdx) for details on
