...
func (s *Service) Start(ctx context.Context, req *api.StartRequest) (*api.StartResponse, error) {
	...
	appProvider := &appProvider{
		...
		clusterConfigCache: vnet.NewClusterConfigCache(s.cfg.Clock),
...
func (p *appProvider) ResolveAppInfo(ctx context.Context, fqdn string) (*vnetv1.AppInfo, error) {
...
func (p *appProvider) GetCachedClusterConfig(ctx context.Context, clt vnet.ClusterClient) (*vnet.ClusterConfig, error) {
...
func (p *appProvider) GetDialOptions(ctx context.Context, profileName string) (*vnetv1.DialOptions, error) {
...
func (p *appProvider) OnInvalidLocalPort(ctx context.Context, appInfo *vnetv1.AppInfo, routeToApp *proto.RouteToApp) {
