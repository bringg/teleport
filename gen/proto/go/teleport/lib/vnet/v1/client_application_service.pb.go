...
type TargetOSConfiguration struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// dns_zones is a list of all DNS zones that VNet should handle queries for. This
	...
	// ipv4_cidr_ranges is a list of IPv4 CIDR ranges that VNet addresses may be
