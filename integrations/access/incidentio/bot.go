...
func (b *Bot) FetchOncallUsers(ctx context.Context, req types.AccessRequest) ([]string, error) {
	// FetchOncallUsers is not implemented for incident.io bot.
	// This is because incident.io does not have a concept of on-call users.
	// Instead, it uses schedules to determine who should be notified.
	return nil, trace.NotImplemented("fetch on-call users not implemented for incident.io bot")
}
